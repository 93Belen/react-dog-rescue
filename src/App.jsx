  ...
  return (
    ...
    <div className="App w-full text-black font-[300] h-fit text-[1.25rem]">
      <section className='flex box-border flex-col gap-6 px-4 md:px-10 xl:px-32 py-12 pt-4 md:grid md:grid-cols-2 md:gap-y-10 md:gap-x-12 md:p-12 md:grid-rows-[10%_80%] h-fit'>
          ...
          <p className='md:col-start-1 xl:justify-self-end'>Lucky 13 Rescue is an organization dedicated to the rescue and aid of homeless
          ...
          <img className='w-full rounded-lg md:col-start-2 md:row-start-2 md:row-span-2 md:w-auto md:h-[80%] md:mx-auto object-cover object-[25%]' src="./troy.png" alt="" />
      </section>
      ...
      <h2 className='text-[2rem]'>Adoption Application</h2>
        ...
        <AdoptButton />
        <img className='md:col-start-2 rounded-lg md:row-start-1 hidden md:block md:row-span-2 md:w-auto md:h-full md:mx-auto object-cover object-[25%]' src="./troy-3.png" alt="" />
      </section>
      ...
      <h2 className='text-[2rem]'>Donate</h2>
        ...
        <DonateButton/>
        <img className='w-full rounded-lg md:col-start-1 md:row-start-1 md:row-span-3 md:w-auto md:h-[90%] md:mx-auto object-cover object-[25%]' src="./troy-2.png" alt="" />
      </section>
