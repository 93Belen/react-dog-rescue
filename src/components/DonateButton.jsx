...
export default function DonateButton(props){
    ...
    if(paypal){
        return (
            <Link target="_blank" to='https://www.paypal.com/paypalme/lucky13rescue' className='bg-yellow rounded-2xl font-[200] w-[9.93rem] flex justify-center items-center h-[2.31rem] text-black text-[1.25rem]' >
            Donate
            </Link>
        )
    } else {
